...
ifeq ($(UNAME_S), Linux)
	CC=g++
	LIBS=-lSDL2 -lGLEW -lGL -lassimp -lSOIL
# Mac
else
	CC=clang++
	LIBS=-lSDL2 -framework OpenGL -framework Cocoa -lGLEW -stdlib=libc++ -lassimp -lSOIL -I/usr/include/bullet -lBulletDynamics -lBulletSoftBody -lBulletCollision –lLinearMath
...
# .o Compilation
O_FILES=main.o camera.o engine.o graphics.o   shader.o window.o InputManager.o #object.o
...
InputManager.o: ../src/InputManager.cpp
	$(CC) $(CXXFLAGS) -c ../src/InputManager.cpp -o InputManager.o $(INDLUDES)
